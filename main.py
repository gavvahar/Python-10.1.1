...
movies = ["Free Guy", "Tokyo Drift", "Baby Driver", "Need for Speed"]
...
myString = "1967 mustang shelby gt500"
...
# function for questions 10 B & C
def sio(name, inputs):
  for i in students_in_order:
    if(students_in_order[i]["name"] == name):
      print(students_in_order[i][inputs])
